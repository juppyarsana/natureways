...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Journal / magazine posts, used on the homepage 'Recent stories' grid and future article pages";
    displayName: 'Article';
    pluralName: 'articles';
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Section-by-section content for the natureways.id homepage';
  ...
  attributes: {
    ...
    featureArticle: Schema.Attribute.Relation<
      ...
      'api::article.article'
    >;
    featureBody: Schema.Attribute.Text;
    featureCtaLabel: Schema.Attribute.String;
    ...
    journalImages: Schema.Attribute.Component<'shared.journal-image', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    pillars: Schema.Attribute.Component<'homepage.pillar', true>;
    publishedAt: Schema.Attribute.DateTime;
    recentArticles: Schema.Attribute.Relation<
      'manyToMany',
      'api::article.article'
    >;
...
export interface ApiPillarPillar extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'The four top-level content pillars: Food, Space, Nature, Workshop';
    displayName: 'Pillar';
    pluralName: 'pillars';
    singularName: 'pillar';
  };
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global nav/footer content shared across the site';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerAboutLinks: Schema.Attribute.Component<'shared.nav-link', true>;
    footerBrandDesc: Schema.Attribute.Text;
    footerConnectLinks: Schema.Attribute.Component<'shared.nav-link', true>;
    footerCopyrightText: Schema.Attribute.String;
    footerExploreLinks: Schema.Attribute.Component<'shared.nav-link', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiSubcategorySubcategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Second-level taxonomy terms under each Pillar';
